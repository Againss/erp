 ...
 * @LastEditors: OBKoro1
 * @LastEditTime: 2021-07-13 13:43:05
 * @FilePath: d:\yangban\src\views\customer-order\sample-orders\detail\common\stripe.vue
-->
<template>
  <div class="">
    <!-- 选择弹窗 -->
  ...
  methods: {
    ...
    popHandle(val, type) {
      ...
      if (this[`${type}PopOptions`].visible) {
        this.encryptFn(this[`${type}Content`], this.rulea, val && val.startsWith('新增') && 'add' || 'edit')
      }
