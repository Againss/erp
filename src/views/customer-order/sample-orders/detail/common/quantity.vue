 ...
 * @LastEditors: OBKoro1
 * @LastEditTime: 2021-07-27 15:43:02
 * @FilePath: d:\erp\src\views\customer-order\sample-orders\detail\common\quantity.vue
-->
<template>
  <!-- 数量交期弹窗 -->
  <div class="pop">
  ...
  data() {
    ...
    const quantityDeliveryContent = {
      ...
      _amountTax: {
        ...
        itemType: 'input',
        isShow: (scope) => {
          return this.pratesFromData.isSettlement
        },
        itemStyle: { width: '48%', display: 'inline-block', 'margin-right': '2%' },
        disabled: true,
        clearable: true
