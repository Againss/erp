 ...
 * @LastEditors: OBKoro1
 * @LastEditTime: 2021-07-19 16:48:52
 * @FilePath: d:\erp\src\views\customer-order\sample-orders\detail\api\detailFun.js
 */
import { queryColorNoPage, queryFlowerNoPage, ColorCodePage, FlowerCodePpage } from '../api/index'
    ...
    getLDFromData() {
      ...
      this.chooseSearch = {
        ...
        _operate: {
          ...
          submitHandle: params => {
            if (params.id) {
              params.colorPlateOrderCodes = []
              params.colorPlateOrderCodes.push(params.id)
            }
