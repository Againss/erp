...
// 查询克重区间范围
export function fabricWeightRange(data = {}) {
  return request({
    url: '/product/api/range/fabricWeight/searchRange',
    method: 'post',
    data: { ...data }
    // ,
    // headers: {
...
// 查询幅宽区间范围
export function fabricWidthRange(data = {}) {
  return request({
    url: '/product/api/range/fabricWidth/searchRange',
    method: 'post',
    data: { ...data }
    // ,
    // headers: {
