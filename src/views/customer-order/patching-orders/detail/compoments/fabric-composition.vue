 ...
 * @Author: Againss
 * @LastEditTime: 2021-07-13 10:22:23
 * @LastEditors: Againss
 * @Descripttion: 面料成份比例
-->
<template>
  <div ref="fabricComposition" class="order-items goods-order-items">
    <div class="header-top">
      ...
      <span>面料成分/比例</span>
      <!-- <el-button v-if="isEdit&&rowIndex!==0" type="primary" size="mini" @click="addFabricComposition">选择</el-button> -->
    </div>
        ...
        item.ingredients.forEach(i => {
          ...
          if (index !== -1) {
            ...
            resultData.push({
              ...
              type: this.findTypeIs2(i.classification.uuid) ? 2 : 1, // 根据返回的数据  确定是选择的成分分类还是单一成分
              ingredients: [{
                uuid: i.uuid,
                name: i.name,
                nameEn: i.nameEn
