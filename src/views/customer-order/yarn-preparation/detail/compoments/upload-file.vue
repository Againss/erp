 ...
 * @LastEditors: OBKoro1
 * @LastEditTime: 2021-06-24 19:00:41
-->
<template>
  <div class="upload-file yarnprepartinomn">
    <div class="flex_come">
      <div class="flex_left" :class="formDatas.isEdit?'':'flex_left_disable'">{{ allText }}</div>
        ...
        <template v-if="getTypes(allfileNames)">
          <div v-for="(item, index) in allfileNames" :key="index">
            <div v-if="item" style="padding-left: 14px;margin-bottom: 4px; white-space: nowrap;">
              <span v-if="item.name"><i class="el-icon-document" /></span>
              <span
