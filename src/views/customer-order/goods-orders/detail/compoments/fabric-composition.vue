 ...
 * @Author: Againss
 * @LastEditTime: 2021-07-14 16:07:37
 * @LastEditors: Againss
 * @Descripttion: 面料成份比例
-->
<template>
  <div ref="fabricComposition" class="order-items goods-order-items">
    <div class="header-top">
      ...
      <el-button v-if="isEdit&&rowIndex!==0&&materialData&&materialData.length" type="primary" size="mini" @click="addFabricComposition"><span style="font-size: 14px;">选择</span></el-button>
    </div>
