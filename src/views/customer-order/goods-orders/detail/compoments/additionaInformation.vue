 ...
 * @LastEditors: OBKoro1
 * @LastEditTime: 2021-05-28 14:23:55
 * @FilePath: e:\备份\com\src\views\customer-order\goods-orders\detail\compoments\additionaInformation.vue
-->
<template>
  <div class="qualityrequ">
    ...
    <div
      v-if="
        !isEdit || (isEdit && orderData.demandSource && orderData.demandCode)
      "
      class="table-item basic-data"
    >
      <div class="header-top basic-top">
      ...
      _transportMode: {
        ...
        visibleChange: (value, val) => {
          if (value) {
            ...
            // this.getOptionConfigSelect({ pageName: '大货订单', fieldName: '运输方式' }, 'transportMode')
          }
        },
        dataSource: [],
