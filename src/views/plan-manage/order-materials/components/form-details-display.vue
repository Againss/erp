  ...
  <div class="form-details-display">
    <template v-if="dataSource.length">
      <div v-for="(item, index) in dataSource" :key="index" class="form-details-display-item">
        <div :ref="'headerList' + index" class="headerList" :class="item.expandFlag ? 'expand' : 'notExpand'">
        ...
        <div class="contentList">
          <cs-custom-form ref="searchForm" :data-source="[{...customFormData[0], spanMethod: ({ row, column, rowIndex, columnIndex }) => {return spanMethod({ row, column, rowIndex, columnIndex }, item.details || [])}, dataSource: item.details || []}]" :options="formOtions" />
        </div>
      <!-- <div class="contentList">
...
export default {
  ...
  methods: {
    moreClick(item) {
      ...
      console.log(this.$refs['headerList0'][0].offsetHeight)
    },
