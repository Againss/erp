<template>
  <div class="upload-wms-pro">
    <template v-if="componentsOptions.type === 'product'">
    ...
    <div
      v-if="componentsOptions.filelist && componentsOptions.filelist.length > 0 && componentsOptions.type === 'product'"
      class="file-list"
...
export default {
  ...
  mounted() {
    console.log('打印type', this.componentsOptions)
