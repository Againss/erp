<template>
  <div class="relevant-table">
    ...
    <div v-if="dataSource.length > 10 && relevantOptions.isTwo" @click="relevantOptions.viewAll" class='viewAll'>查看全部</div>
    <!-- 导入pop弹出层 -->
    <div class="pop">
  ...
  computed: {
      ...
      twoDataSource () {
          if (this.relevantOptions.isTwo) {
            return this.dataSource.length > 10 ? this.dataSource.slice(0,10) : this.dataSource
          } else {
