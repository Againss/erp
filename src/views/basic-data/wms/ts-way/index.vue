 ...
 * @version:
 * @Author: shujing
 * @Date: 2020-09-23 11:33:26
 * @LastEditors: shujing
 * @LastEditTime: 2020-11-16 13:56:25
-->
...
<template>
  <div class="tsway">
    ...
    <div class="button">
      <el-button
        v-permission="['basic:shipMethod:store']"
        type="primary"
        icon="el-icon-plus"
        size="small"
        @click="addRange"
  ...
  data() {
    ...
    const columns = [
      ...
      },
      {
        ...
        componentsOptions: {
          permitTag: 'basic:shipMethod:enabled',
          changeStatus: (scope) => {
    ...
    let popOperatesList = [
      {
        label: '审核',
        permitTag: ['basic:shipMethod:approve'],
        isShow: (scope) => {
      ...
      {
        label: '编辑',
        permitTag: ['basic:shipMethod:update'],
        isShow: true,
        handle: scope => {
      ...
      },
      {
        label: '删除',
        style: { 'color': '#FE4949' },
        permitTag: ['basic:shipMethod:destroy'],
        isShow: (scope) => {
          return scope.row.status.code === 'B'
        },
        handle: scope => {
