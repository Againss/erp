 ...
 * @LastEditors: shujing
 * @LastEditTime: 2020-10-20 13:41:44
 */
...
export function sysDataGroupEnable(data) {
  return request({
    url: '/basis/api/printingDyeingType/enabled',
    method: 'post',
    data
  })
}
...
export function sysDataGroupAdd(data) {
  return request({
    url: '/basis/api/printingDyeingType/store',
    method: 'post',
    data
  })
}
...
export function sysDataGroupModify(data) {
  return request({
    url: '/basis/api/printingDyeingType/update',
    method: 'post',
    data
  })
}
...
export function sysDataGroupDelete(data) {
  return request({
    url: '/basis/api/printingDyeingType/destroy',
    method: 'post',
    data
  })
}
...
export function sysDataGroupExam(data) {
  return request({
    url: '/basis/api/printingDyeingType/approve',
    method: 'post',
    data
  })
}
...
export function sysDataGroupInfo(data) {
  return request({
    url: '/basis/api/printingDyeingType/show',
    method: 'post',
    data
  })
}
