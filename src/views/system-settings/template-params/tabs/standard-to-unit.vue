...
import { getSettings, saveSettings, unitSelect } from '../api'
...
export default {
  ...
  watch: {
    popEdit(val) {
      this.popOptions.title = val ? '编辑规格可选单位' : '新增规格可选单位'
  ...
  methods: {
    ...
    reverseData(newRow) {
      newRow.settingType = newRow.settingType || SETTING_TYPE.STANDARD_TO_UNIT
