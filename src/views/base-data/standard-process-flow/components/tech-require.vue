 ...
 * @Author: Againss
 * @LastEditTime: 2021-01-11 20:11:30
      ...
      <div class="tech">
        ...
        <div class="content">
          <el-scrollbar class="cont">
            <!-- 字母复选框 -->
            <div v-show="activeName === 'normal' || activeName === 'print'">
            ...
            <!-- 树 -->
            <div
              v-show="activeName === 'function' || activeName === 'feelStyle'"
              class="tree"
            >
              <el-tree
                ref="treeRef"
  ...
  computed: {
    ...
    defaultExpandedKeys() {
      ...
      const arr = this.checkValList.filter(item => {
        return (item.type === 2 || item.type === 3) && item.parentUuid
      })
      if (arr && arr.length) {
        return arr.map(item => {
