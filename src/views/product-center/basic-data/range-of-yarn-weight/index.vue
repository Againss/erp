 ...
 * @Author: Againss
 * @LastEditTime: 2021-05-08 11:28:10
 * @LastEditors: anthony
 * @Descripttion:克重区间
-->
<template>
  <div class="paymentPage">
    ...
    <div class="button">
      <el-button v-permission="['catalog:Api:Range:fabricWeight:store']" type="primary" size="small" icon="el-icon-plus" @click="addList">新增</el-button>
    </div>
    <!-- table表格 -->
  ...
  methods: {
    ...
    async addData(data = {}) {
      ...
      this.fetchLog(
        this.getLogMessages(
          'INSERT',
          `product/api/range/fabricWeight/store`
        ),
        data,
        JSON.stringify({
          beforeText: `在'产品目录库-数据配置-克重区间'新增一条记录`,
          beforeCode: data
        })
      )
    },
