...
const optionsRadiosQR = $('#optionsRadiosQR')
...
changeLogin.on('click', function(e) {
  loginType = loginType === 'userCode'?'QRcode':'userCode'
  $('#QrCodeLogin').toggleClass('dis-none')
  $('#userLoginPage').toggleClass('dis-none')
  $('.loginAndPassword').toggleClass('QRcode')
  const value = $('.active').attr('data-type')
  languageDom.removeClass('active')
  switch (value) {
    case 'chinese':
        $('#chinese-qr').addClass('active')
        $('#chinese').addClass('active')
      break;
    default:
        $('#english-qr').addClass('active')
